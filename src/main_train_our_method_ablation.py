...
class Trainer:
    def __init__(self):
        ...
        self.reseter = nn.TransformerEncoder(nn.TransformerEncoderLayer(d_model=2048, nhead=32), num_layers=24) 
        ...
        for epoch in range(num_epochs):
            ...
            if (epoch + 1) % 50 == 0:
                torch.save({
                    ...
                    'model_state_dict': self.model.state_dict(),
                    'optimizer_state_dict': optimizer.state_dict(),  # Optional, if you want to resume training
                }, save_dir + "/final_head_fallb_walked80_epoch-" + str(epoch + 1) + ".model")
            ...
            if test_score > best_score:
                ...
                torch.save({
                    ...
                    'model_state_dict': self.model.state_dict(),
                    'optimizer_state_dict': optimizer.state_dict(),  # Optional, if you want to resume training
                }, save_dir + "/final_head_fallb_walked80_epoch-best" + ".model")
