...
lmdb_path = '/scratch/xz4863/TSM_features/'
...
def save_statistic_input(views):
    ...
    with open('/home/xz4863/scratch/o_c2f/data/statistic_input_v3v4e4.pkl', 'wb') as f:
        pkl.dump(total, f)


# main function
if __name__ == '__main__':
    # views = ['C10118',  'C10119', 'HMC_21179183_mono10bit', 'HMC_84358933_mono10bit']
