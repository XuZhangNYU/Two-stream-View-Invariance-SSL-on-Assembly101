...
class Trainer:
    def __init__(self):
        ...
        transformer_weight_name = '/final_transformer_exchang_enc_epoch-200-v3.model'
        # c2f_weight_name = '/c2f_epoch-best-batch64-large_step-chunk20-maxfram1200-v3.model'

        self.transformer.load_state_dict(torch.load(model_dir + transformer_weight_name, map_location=device))
        ...
        for epoch in range(num_epochs):
            ...
            if (epoch + 1) % 50 == 0:
                torch.save({
                    ...
                    'model_state_dict': self.model.state_dict(),
                    'optimizer_state_dict': optimizer.state_dict(),  # Optional, if you want to resume training
                }, save_dir + "/final_head_exchang_enc_naive_ssl-" + str(epoch + 1) + ".model")
            ...
            if test_score > best_score:
                ...
                torch.save({
                    ...
                    'model_state_dict': self.model.state_dict(),
                    'optimizer_state_dict': optimizer.state_dict(),  # Optional, if you want to resume training
                }, save_dir + "/final_head_exchang_naive_ssl-best" + ".model")
...
run = wandb.init(
    project="Assembly101-experiments-2nd",    # Specify your project
